...
const Counter = () => {
    ...
    return <>
        <h2>{count}</h2>
        <div>
            <button disabled={isLoading} onClick={() => dispatch(increment())}>increment 1</button>
            <br />
            <button disabled={isLoading} onClick={() => dispatch(decrement())}>decrement 1</button>
            <br />
            <button disabled={isLoading} onClick={() => dispatch(incrementByAmount(10))}>increment by 10</button>
            <br />
            <button disabled={isLoading} onClick={() => dispatch(incrementAsync({ message: 'query_inutil' }))}>
